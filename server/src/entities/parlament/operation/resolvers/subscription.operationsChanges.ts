...
import { OperationEvents } from '../controller/operation.events';
...
export const operationChangesSubscription: IResolverObject = {
  subscribe: withFilter(
    () => pubsub.asyncIterator(OperationEvents.OPERATIONS_CHANGED),
    (
