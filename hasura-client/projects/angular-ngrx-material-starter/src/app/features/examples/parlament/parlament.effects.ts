...
export class ParlamentEffects {
  ...
  //             actions.push(
  //               parlamentAction.actionOperationDesiredByIds({
  //                 ids: idsFromBackend
  //               })
  //             );
  //           }
  ...
  //   this.actions$.pipe(
  //     ofType(parlamentAction.actionOperationDesiredByIds),
  //     withLatestFrom(
  //       this.store
  ...
  //         actions.push(
  //           parlamentAction.actionOperationDesiredByIds({ ids: desiredIds })
  //         );
  //       }
